...
namespace rl_tools::checkpoint::example::input {
    static_assert(sizeof(unsigned char) == 1);
    alignas(float) const unsigned char memory[] = {196, 224, 121, 62, 110, 128, 30, 191, 228, 167, 7, 63, 153, 243, 88, 189, 194, 229, 138, 62, 125, 246, 200, 190, 155, 161, 178, 63, 40, 204, 138, 63, 28, 9, 101, 191, 206, 127, 211, 190, 43, 200, 45, 63, 25, 211, 68, 62, 153, 249, 119, 63, 165, 123, 201, 189, 108, 193, 173, 189, 192, 156, 164, 191, 41, 78, 212, 191, 103, 38, 23, 63, 236, 101, 79, 62, 250, 80, 4, 63, 84, 51, 231, 189, 114, 3, 92, 191, 129, 81, 7, 190, 37, 90, 29, 191, 66, 246, 175, 191, 151, 3, 140, 62, 173, 35, 126, 62, 35, 163, 251, 62, 49, 202, 47, 191, 116, 194, 51, 63, 15, 182, 0, 189, 138, 42, 22, 192, 147, 110, 198, 190, 212, 175, 163, 191, 90, 239, 217, 62, 94, 189, 187, 191, 119, 235, 153, 191, 199, 7, 40, 63, 136, 73, 107, 191};
...
namespace rl_tools::checkpoint::example::output {
    static_assert(sizeof(unsigned char) == 1);
    alignas(float) const unsigned char memory[] = {107, 61, 207, 61, 51, 13, 255, 61, 18, 128, 45, 189, 22, 88, 73, 62, 128, 129, 46, 186, 48, 223, 89, 62, 16, 81, 204, 61, 236, 253, 80, 62, 17, 137, 146, 62, 209, 153, 163, 61, 232, 123, 130, 61, 98, 198, 97, 62, 6, 252, 121, 62};
...
namespace rl_tools::checkpoint::meta{
   char name[] = "experiments/2025-10-08_22-10-48/f972979_zoo_environment_algorithm/pendulum-v1_ppo/0005/steps/000000000000000";
