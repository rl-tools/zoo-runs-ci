...
namespace rl_tools::checkpoint::example::input {
    static_assert(sizeof(unsigned char) == 1);
    alignas(float) const unsigned char memory[] = {43, 126, 94, 62, 95, 111, 3, 191, 114, 114, 95, 191, 81, 46, 14, 62, 99, 152, 245, 63, 51, 207, 182, 63, 177, 32, 217, 191, 27, 189, 222, 191, 178, 21, 4, 190, 247, 103, 116, 63, 210, 58, 252, 63, 232, 120, 137, 63, 125, 3, 104, 188, 138, 172, 138, 62, 233, 248, 133, 63, 109, 134, 166, 63, 123, 98, 1, 63, 56, 171, 157, 189, 144, 179, 219, 62, 96, 47, 5, 64, 223, 104, 142, 62, 150, 80, 197, 61, 126, 229, 206, 189, 184, 141, 104, 191, 164, 1, 76, 63, 104, 98, 33, 192, 106, 83, 209, 62, 239, 19, 217, 60, 67, 87, 117, 191, 110, 27, 124, 63, 113, 69, 197, 191, 193, 202, 135, 63, 9, 176, 238, 62, 234, 96, 71, 190, 37, 244, 125, 191, 70, 119, 180, 63, 20, 164, 59, 188, 220, 243, 35, 190, 35, 179, 72, 63};
...
namespace rl_tools::checkpoint::example::output {
    static_assert(sizeof(unsigned char) == 1);
    alignas(float) const unsigned char memory[] = {208, 136, 248, 189, 188, 86, 200, 61, 133, 46, 191, 190, 250, 196, 0, 62, 200, 188, 27, 189, 170, 15, 132, 61, 96, 128, 217, 61, 252, 11, 209, 189, 146, 2, 56, 190, 178, 66, 28, 190, 79, 146, 42, 190, 167, 154, 59, 190, 132, 72, 170, 189};
...
namespace rl_tools::checkpoint::meta{
   char name[] = "experiments/2025-10-08_22-51-36/cea361a_zoo_environment_algorithm/pendulum-v1_ppo/0006/steps/000000000000000";
