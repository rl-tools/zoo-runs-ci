...
namespace rl_tools::checkpoint::example::input {
    static_assert(sizeof(unsigned char) == 1);
    alignas(float) const unsigned char memory[] = {172, 24, 6, 192, 20, 177, 226, 189, 2, 181, 173, 191, 6, 91, 5, 63, 238, 106, 63, 62, 67, 112, 225, 63, 194, 238, 7, 190, 199, 12, 182, 62, 171, 228, 40, 62, 113, 182, 216, 185, 44, 131, 178, 63, 47, 218, 131, 191, 102, 106, 143, 63, 255, 67, 6, 64, 105, 119, 35, 192, 197, 43, 212, 191, 85, 213, 182, 63, 68, 50, 131, 191, 142, 59, 189, 63, 144, 139, 137, 63, 207, 156, 243, 189, 114, 67, 177, 63, 35, 185, 122, 191, 114, 189, 3, 191, 137, 172, 114, 191, 96, 55, 14, 190, 230, 156, 151, 190, 174, 37, 173, 63, 21, 225, 207, 191, 144, 44, 204, 63, 254, 128, 236, 61, 30, 57, 25, 64, 249, 98, 118, 189, 96, 83, 1, 191, 159, 101, 237, 60, 239, 148, 177, 191, 131, 178, 221, 191, 9, 116, 9, 62, 40, 159, 189, 190};
...
namespace rl_tools::checkpoint::example::output {
    static_assert(sizeof(unsigned char) == 1);
    alignas(float) const unsigned char memory[] = {108, 129, 166, 189, 137, 149, 220, 62, 22, 104, 81, 62, 80, 80, 64, 61, 64, 205, 180, 187, 192, 10, 95, 189, 53, 124, 119, 62, 240, 60, 100, 62, 240, 202, 176, 61, 182, 29, 239, 62, 121, 230, 51, 62, 120, 74, 21, 189, 36, 141, 216, 60};
...
namespace rl_tools::checkpoint::meta{
   char name[] = "experiments/2025-10-08_22-51-36/cea361a_zoo_environment_algorithm/pendulum-v1_ppo/0007/steps/000000000000000";
