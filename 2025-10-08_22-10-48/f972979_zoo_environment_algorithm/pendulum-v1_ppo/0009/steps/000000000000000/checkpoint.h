...
namespace rl_tools::checkpoint::example::input {
    static_assert(sizeof(unsigned char) == 1);
    alignas(float) const unsigned char memory[] = {180, 165, 14, 63, 22, 129, 53, 63, 117, 92, 191, 190, 164, 72, 199, 191, 67, 207, 186, 62, 251, 228, 218, 62, 198, 130, 178, 63, 223, 237, 190, 189, 253, 77, 18, 64, 176, 35, 156, 190, 245, 118, 51, 191, 48, 200, 208, 191, 76, 248, 132, 62, 213, 137, 14, 192, 77, 85, 110, 61, 47, 150, 98, 191, 30, 164, 133, 191, 228, 174, 153, 63, 168, 2, 51, 191, 148, 193, 249, 191, 208, 33, 136, 191, 231, 144, 88, 191, 110, 155, 121, 63, 101, 193, 26, 62, 137, 77, 19, 62, 72, 244, 170, 190, 40, 121, 214, 63, 75, 94, 152, 63, 139, 22, 143, 191, 102, 28, 209, 63, 45, 3, 101, 191, 99, 188, 124, 61, 36, 182, 134, 191, 7, 251, 247, 63, 110, 120, 255, 191, 228, 200, 212, 63, 109, 161, 63, 191, 68, 151, 37, 190, 164, 97, 173, 62};
...
namespace rl_tools::checkpoint::example::output {
    static_assert(sizeof(unsigned char) == 1);
    alignas(float) const unsigned char memory[] = {228, 103, 55, 189, 206, 8, 121, 190, 56, 36, 149, 61, 160, 217, 80, 188, 53, 219, 88, 62, 14, 238, 60, 189, 92, 180, 100, 61, 157, 90, 135, 190, 208, 210, 131, 188, 231, 43, 43, 62, 60, 41, 36, 190, 198, 162, 150, 62, 160, 107, 230, 189};
...
namespace rl_tools::checkpoint::meta{
   char name[] = "experiments/2025-10-08_22-10-48/f972979_zoo_environment_algorithm/pendulum-v1_ppo/0009/steps/000000000000000";
