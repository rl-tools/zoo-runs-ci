...
namespace rl_tools::checkpoint::example::input {
    static_assert(sizeof(unsigned char) == 1);
    alignas(float) const unsigned char memory[] = {52, 102, 145, 63, 147, 42, 139, 190, 182, 114, 79, 191, 217, 38, 15, 63, 108, 4, 232, 191, 77, 224, 216, 63, 140, 161, 133, 190, 232, 69, 86, 63, 39, 35, 141, 191, 230, 48, 147, 63, 82, 102, 244, 62, 61, 46, 217, 62, 211, 135, 216, 63, 129, 161, 5, 191, 44, 26, 183, 190, 104, 207, 92, 191, 149, 215, 113, 191, 183, 66, 37, 191, 57, 43, 158, 191, 222, 129, 127, 62, 145, 68, 6, 63, 130, 175, 175, 191, 127, 68, 238, 60, 64, 255, 168, 190, 211, 28, 106, 63, 215, 78, 71, 63, 126, 253, 132, 191, 98, 64, 153, 62, 216, 141, 190, 63, 201, 203, 22, 63, 146, 209, 11, 64, 246, 116, 148, 191, 55, 5, 128, 189, 61, 39, 33, 63, 213, 189, 85, 190, 204, 192, 120, 191, 167, 199, 254, 191, 226, 122, 104, 63, 188, 123, 85, 63};
...
namespace rl_tools::checkpoint::example::output {
    static_assert(sizeof(unsigned char) == 1);
    alignas(float) const unsigned char memory[] = {248, 198, 41, 188, 196, 187, 36, 62, 228, 112, 203, 189, 104, 44, 187, 188, 88, 203, 141, 60, 132, 153, 169, 61, 80, 90, 250, 60, 136, 80, 173, 60, 98, 210, 20, 190, 200, 98, 235, 189, 12, 159, 142, 61, 16, 166, 130, 187, 0, 54, 106, 59};
...
namespace rl_tools::checkpoint::meta{
   char name[] = "experiments/2025-10-08_22-51-36/cea361a_zoo_environment_algorithm/pendulum-v1_ppo/0003/steps/000000000000000";
