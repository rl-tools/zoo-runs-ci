...
namespace rl_tools::checkpoint::example::input {
    static_assert(sizeof(unsigned char) == 1);
    alignas(float) const unsigned char memory[] = {147, 78, 131, 190, 204, 21, 135, 189, 118, 183, 162, 191, 238, 191, 254, 191, 2, 59, 169, 191, 67, 243, 22, 191, 79, 28, 100, 62, 173, 149, 143, 62, 252, 121, 131, 191, 26, 9, 146, 61, 89, 56, 187, 191, 231, 39, 243, 190, 177, 146, 205, 62, 158, 112, 180, 63, 200, 119, 13, 191, 32, 241, 9, 191, 216, 219, 172, 191, 228, 222, 213, 62, 206, 201, 198, 191, 254, 41, 109, 63, 112, 141, 172, 61, 6, 110, 163, 191, 209, 215, 26, 189, 79, 190, 181, 63, 139, 18, 21, 192, 89, 140, 131, 191, 188, 137, 151, 190, 8, 103, 244, 63, 40, 81, 199, 62, 20, 207, 54, 192, 139, 53, 236, 62, 107, 44, 80, 61, 88, 189, 64, 188, 200, 191, 31, 191, 187, 115, 190, 191, 18, 221, 1, 63, 209, 194, 14, 64, 244, 51, 116, 61, 200, 120, 142, 191};
...
namespace rl_tools::checkpoint::example::output {
    static_assert(sizeof(unsigned char) == 1);
    alignas(float) const unsigned char memory[] = {176, 153, 2, 188, 222, 220, 124, 189, 68, 19, 164, 188, 24, 135, 247, 60, 188, 39, 79, 189, 250, 244, 58, 189, 130, 242, 229, 189, 94, 177, 29, 190, 140, 48, 171, 189, 16, 231, 121, 60, 152, 225, 168, 188, 84, 21, 63, 189, 250, 153, 156, 61};
...
namespace rl_tools::checkpoint::meta{
   char name[] = "experiments/2025-10-08_22-51-36/cea361a_zoo_environment_algorithm/pendulum-v1_ppo/0004/steps/000000000000000";
