...
namespace rl_tools::checkpoint::example::input {
    static_assert(sizeof(unsigned char) == 1);
    alignas(float) const unsigned char memory[] = {162, 18, 205, 191, 144, 239, 167, 63, 15, 61, 251, 191, 255, 253, 52, 190, 121, 179, 223, 191, 155, 253, 170, 63, 143, 146, 141, 63, 165, 234, 81, 61, 38, 168, 176, 191, 34, 54, 215, 190, 4, 146, 78, 59, 78, 129, 34, 63, 51, 47, 202, 63, 217, 185, 232, 189, 106, 57, 28, 191, 180, 162, 0, 192, 124, 58, 161, 63, 143, 109, 83, 63, 42, 51, 131, 63, 68, 178, 20, 63, 125, 234, 248, 62, 218, 121, 189, 191, 247, 216, 183, 63, 100, 31, 27, 191, 168, 33, 79, 191, 237, 223, 124, 63, 252, 122, 126, 189, 169, 204, 43, 61, 53, 19, 174, 63, 228, 188, 93, 63, 135, 110, 155, 63, 135, 54, 134, 191, 171, 103, 6, 64, 130, 208, 7, 189, 29, 111, 137, 190, 224, 206, 190, 61, 72, 234, 244, 61, 32, 21, 140, 63, 201, 161, 44, 191};
...
namespace rl_tools::checkpoint::example::output {
    static_assert(sizeof(unsigned char) == 1);
    alignas(float) const unsigned char memory[] = {96, 61, 48, 190, 223, 73, 156, 62, 18, 234, 112, 190, 86, 228, 144, 62, 97, 13, 190, 189, 231, 197, 195, 62, 155, 247, 211, 61, 248, 108, 160, 61, 188, 195, 9, 62, 108, 48, 132, 62, 179, 62, 200, 62, 128, 32, 244, 61, 141, 153, 201, 189};
...
namespace rl_tools::checkpoint::meta{
   char name[] = "experiments/2025-10-08_22-51-36/cea361a_zoo_environment_algorithm/pendulum-v1_ppo/0001/steps/000000000000000";
