...
namespace rl_tools::checkpoint::example::input {
    static_assert(sizeof(unsigned char) == 1);
    alignas(float) const unsigned char memory[] = {132, 16, 191, 61, 156, 232, 244, 63, 106, 176, 196, 191, 49, 10, 130, 191, 117, 4, 163, 61, 127, 212, 20, 63, 99, 254, 141, 189, 234, 27, 141, 63, 241, 200, 26, 191, 217, 155, 97, 191, 105, 9, 187, 63, 23, 90, 117, 63, 159, 163, 188, 61, 230, 78, 34, 190, 190, 112, 243, 190, 44, 243, 93, 63, 252, 45, 235, 62, 51, 95, 78, 190, 101, 10, 98, 63, 117, 49, 56, 63, 104, 44, 33, 191, 142, 156, 179, 62, 100, 178, 191, 63, 255, 224, 61, 191, 181, 220, 156, 63, 53, 239, 83, 191, 199, 195, 137, 62, 210, 74, 125, 63, 134, 107, 200, 188, 105, 229, 42, 191, 166, 201, 116, 62, 129, 149, 3, 192, 242, 205, 37, 63, 215, 99, 222, 191, 117, 250, 68, 63, 46, 183, 62, 62, 187, 105, 222, 191, 7, 76, 135, 191, 38, 216, 79, 63};
...
namespace rl_tools::checkpoint::example::output {
    static_assert(sizeof(unsigned char) == 1);
    alignas(float) const unsigned char memory[] = {76, 28, 115, 61, 200, 126, 56, 62, 116, 151, 95, 61, 132, 54, 129, 62, 44, 128, 235, 188, 236, 183, 190, 60, 32, 169, 84, 59, 176, 204, 116, 61, 32, 70, 100, 187, 190, 35, 73, 189, 0, 119, 214, 185, 10, 55, 52, 62, 161, 28, 54, 62};
...
namespace rl_tools::checkpoint::meta{
   char name[] = "experiments/2025-10-08_22-51-36/cea361a_zoo_environment_algorithm/pendulum-v1_ppo/0000/steps/000000000000000";
