...
namespace rl_tools::checkpoint::example::input {
    static_assert(sizeof(unsigned char) == 1);
    alignas(float) const unsigned char memory[] = {98, 69, 226, 191, 117, 80, 1, 190, 216, 204, 170, 61, 166, 167, 3, 191, 122, 252, 10, 191, 124, 17, 166, 63, 144, 18, 140, 63, 82, 13, 128, 191, 96, 150, 93, 63, 58, 48, 79, 189, 70, 50, 73, 63, 175, 44, 16, 63, 226, 162, 186, 191, 29, 218, 225, 63, 172, 152, 221, 191, 235, 228, 126, 62, 184, 208, 40, 63, 115, 9, 13, 62, 120, 105, 25, 63, 121, 83, 150, 63, 124, 245, 130, 190, 144, 130, 239, 191, 222, 139, 2, 63, 71, 58, 139, 191, 90, 162, 77, 191, 22, 27, 157, 62, 35, 231, 190, 63, 172, 17, 51, 64, 67, 165, 7, 63, 129, 72, 15, 191, 71, 47, 130, 191, 72, 18, 158, 62, 134, 74, 152, 191, 214, 217, 146, 63, 183, 25, 161, 63, 224, 20, 111, 190, 129, 35, 217, 62, 67, 253, 72, 63, 1, 44, 202, 62};
...
namespace rl_tools::checkpoint::example::output {
    static_assert(sizeof(unsigned char) == 1);
    alignas(float) const unsigned char memory[] = {64, 118, 6, 62, 101, 241, 172, 61, 32, 249, 76, 190, 187, 210, 189, 189, 144, 122, 15, 190, 224, 24, 51, 190, 42, 167, 134, 190, 48, 203, 25, 60, 39, 22, 218, 61, 56, 148, 208, 190, 100, 216, 197, 189, 233, 247, 159, 190, 36, 217, 55, 190};
...
namespace rl_tools::checkpoint::meta{
   char name[] = "experiments/2025-10-08_22-51-36/cea361a_zoo_environment_algorithm/pendulum-v1_ppo/0008/steps/000000000000000";
