...
namespace rl_tools::checkpoint::example::input {
    static_assert(sizeof(unsigned char) == 1);
    alignas(float) const unsigned char memory[] = {185, 24, 144, 190, 128, 41, 63, 62, 115, 87, 81, 63, 238, 190, 162, 188, 147, 131, 131, 62, 105, 193, 44, 191, 12, 94, 93, 190, 162, 172, 131, 63, 41, 242, 30, 191, 213, 64, 201, 191, 117, 147, 239, 191, 208, 155, 80, 191, 181, 38, 147, 61, 159, 144, 9, 64, 215, 16, 156, 63, 250, 211, 183, 191, 117, 186, 241, 190, 202, 185, 239, 63, 48, 59, 30, 192, 176, 190, 38, 191, 221, 70, 180, 63, 57, 3, 31, 62, 154, 30, 241, 62, 192, 221, 195, 190, 160, 100, 131, 191, 44, 187, 205, 189, 118, 164, 238, 62, 253, 226, 43, 192, 184, 74, 140, 190, 181, 67, 41, 61, 222, 117, 219, 62, 188, 175, 151, 63, 140, 117, 169, 190, 197, 10, 95, 63, 240, 42, 206, 191, 161, 37, 149, 189, 230, 79, 180, 62, 160, 101, 160, 191, 11, 192, 229, 190};
...
namespace rl_tools::checkpoint::example::output {
    static_assert(sizeof(unsigned char) == 1);
    alignas(float) const unsigned char memory[] = {222, 164, 199, 189, 4, 65, 127, 190, 120, 223, 145, 190, 91, 9, 8, 190, 118, 164, 40, 190, 62, 66, 1, 189, 110, 49, 208, 189, 86, 174, 97, 190, 49, 204, 22, 190, 149, 34, 66, 190, 212, 248, 105, 190, 203, 180, 97, 189, 132, 212, 233, 189};
...
namespace rl_tools::checkpoint::meta{
   char name[] = "experiments/2024-11-28_01-55-51/1586e62_zoo_environment_algorithm/pendulum-v1_ppo/0002/steps/000000000000000";
